          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {battle
                ...
                : "Name an athlete who satisfies both criteria. Type the full answer from memory — no player suggestions are shown."}
            </DialogDescription>
          </DialogHeader>
          ...
          >
            <div className="flex-1">
              <input
                ...
                className="min-h-11 w-full rounded-xl border border-border bg-background px-3 text-base font-semibold outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 disabled:opacity-60"
              />
              <p className="mt-1.5 text-xs text-muted-foreground">
                No suggestions. Accents and punctuation do not matter; recognised aliases are
                accepted.
              </p>
            </div>
