...
-- Legacy verified rows without provenance cannot satisfy verified_question_has_source
-- once they are touched. Park them for staff review instead of serving unsourced content.
update public.question_bank
set verification_status = 'pending', active = false
where verification_status = 'verified'
  and (source_id is null or source_url is null or reviewed_at is null);
